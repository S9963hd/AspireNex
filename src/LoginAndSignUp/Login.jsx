    ...
    const[floading,setFloading]=useState(false);
     function retrivepassword(email){
        ...
        axios({
            ...
            method:"POST",
            data:{email:email},
        }).then(res=>{console.log("Sended Successfully.....");notify(res.status)}).catch(err=>{console.log("Somthing Wrong")(err.response.status!=null)?notify(err.response.status):notify(404)});
    }
